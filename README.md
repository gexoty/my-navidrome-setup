...
npm_default
```
После этого используем docker-compose.yml из репозитория. Не забудь перед этим отредактировать api_key и secret для Last.FM и заменить Логин и Пароли на свои
